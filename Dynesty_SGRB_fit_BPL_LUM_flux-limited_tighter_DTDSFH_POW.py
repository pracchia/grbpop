...
if __name__=='__main__':
    ...
    # checkpoint_filename = f'nested_samplings/draft_nested_BPL_flux-limited_tighter_Poisson_dtdsfh_POW_dlogz{dlogz}_nlive{nlive}_nbatch{nbatch}_neff{N_effective_sample}.save' # Linear DTD params
    checkpoint_filename = f'nested_samplings/final_nested_BPL_flux-limited_tighter_Poisson_dtdsfh_POW_dlogz{dlogz}_nlive{nlive}_nbatch{nbatch}_neff{N_effective_sample}.save' # Log DTD params
