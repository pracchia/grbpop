...
def logprior(theta_pop):
    ...
    or theta_pop['Lc*']<1e49 or theta_pop['Lc*']>1e55\
    ...
    or theta_pop['R0']<1. or theta_pop['R0']>1e5:
        return -np.inf
    else:
...
if __name__=='__main__':
    ...
    x0 = [-1.877,     51.55, 4.091, -2.318, 3.804,    1.2,   2.069, -0.5058, 3.041, -0.01476, -0.1149, 4.431, 4.623, 2.051, 3.48]  # starting guess
