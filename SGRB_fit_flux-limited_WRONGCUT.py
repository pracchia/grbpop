...
if __name__=='__main__':
    nthreads = 8
    N_iter = 10000
    chain_filename = 'chains/SGRB_flux-limited-sample-analysis_WRONGCUT.h5' # full
    
    # initial guess vector
    #      log(thj)  log(Lj) a_L      b_L   log(Epj) a_Ep    b_Ep  log(thw)     A    log(s_c)        y        a      b    zp    
    x0 = [-1.877,     51.55, 4.091, -2.318, 2.903,    1.2,   2.069, -0.5058, 3.041, -0.6882461, 0.000149, 1.431, 4.623,  0.9]  # starting guess
