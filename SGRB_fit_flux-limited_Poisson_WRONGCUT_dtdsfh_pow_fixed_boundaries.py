...
if __name__=='__main__':
    nthreads = 8
    N_iter = 10000
    chain_filename = 'chains/SGRB_flux-limited-sample-analysis_Poisson_WRONGCUT_dtdsfh_pow_fixed_boundaries_swift_3_5.h5' # full
    # chain_filename = 'chains/SGRB_flux-limited-sample-analysis_Poisson_WRONGCUT_dtdsfh_pow_fixed_boundaries.h5' # full
    
    # initial guess vector
    #      log(thj)  log(Lj) a_L      b_L    a_Ep    b_Ep  log(thw)     A  tdmin   at  log(R0)   
    x0 = [-1.877,    51.55, 2.091,  2.318,   0.04,   5.069,  0.0958, 2.341, 0.02, 0.2,  2.709]  # starting guess
    # x0 = [-1.877,    51.55, 4.091, -2.318,   1.2,   2.069, -0.5058, 3.041, 0.02, 1.,  2.509]  # starting guess
