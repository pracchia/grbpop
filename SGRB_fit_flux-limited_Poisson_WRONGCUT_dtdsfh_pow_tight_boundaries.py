...
def logprior(theta_pop):
    ...
    or theta_pop['Epc*']<790. or theta_pop['Epc*']>810.\
    ...
    or theta_pop['s_c']<0.3 or theta_pop['s_c']>0.5\
    or theta_pop['y']<-0.1 or theta_pop['y']>0.1\
...
if __name__=='__main__':
    nthreads = 8
    N_iter = 10000
    chain_filename = 'chains/SGRB_flux-limited-sample-analysis_Poisson_WRONGCUT_dtdsfh_pow_tight_boundaries.h5' # full
    
    # initial guess vector
    #      log(thj)  log(Lj) a_L      b_L   log(Epj) a_Ep    b_Ep  log(thw)     A    log(s_c)        y    tdmin  at  log(R0)  
    x0 = [-1.877,     51.55, 4.091, -2.318, 2.903,    1.2,   2.069, -0.5058, 3.041,  -0.3979,    0.000149, 0.02, 1., 2.509]  # starting guess
