...
if __name__=='__main__':
    nthreads = 8
    N_iter = 10000
    chain_filename = 'chains/SGRB_flux-limited-sample-analysis_WRONGCUT_fixed_boundaries.h5' # full
    
    # initial guess vector
    #      log(thj)  log(Lj) a_L      b_L     a_Ep    b_Ep  log(thw)     A        a      b    zp    
    x0 = [-1.877,     51.55, 4.091, -2.318,    1.2,   2.069, -0.5058, 3.041,  3.431, 7.623,  0.9]  # starting guess
