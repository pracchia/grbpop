...
def loglike(x):
    ...
    ## Poissonian terms
    log_poisson_obsframe = grbpop.Ppop.log_poissonian_observer(theta_pop,N_obs=len(p50300),eta=eta_GBM,T=T_GBM,logalpha=log_alpha_obsframe,alpha=alpha,specmodel='Comp',inst='Fermi',res=80,pdet=pdet,pflim=p_gbm_lim)
    
    ## sum all contributions
    logl = logl_obsframe + logl_restframe + logl_GW170817 + log_poisson_obsframe
...
if __name__=='__main__':
    ...
    checkpoint_filename = 'nested_samplings/Dynesty_SGRB_flux-limited-sample-analysis_WRONGCUT_Poisson_dtdsfh_log.save'
